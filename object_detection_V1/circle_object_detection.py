...
# Real-world coordinates of ArUco markers (in meters)
aruco_positions = {
    0: (0.0, 0.0),
    1: (-0.6858, 0.0),
    2: (-0.6858, 0.3302),
    ...
    try: 
        ...
        if ids is not None:
            ...
            if len(pixel_positions) == 4:  # Ensure all markers are detected
                ...
                print(f"Number of circles detected: {len(circles_info)}")
                ...
                for i, circle in enumerate(circles_info):
                    ...
                    # Display the area ranking and real-world coordinates
